...
class TtlFileEntry:
    ...
    def _fix_strings(self):
        ...
        self.tStartTime = _fix(self.tStartTime)
        self.wStartTime = _fix(self.wStartTime)
        self.thStartTime = _fix(self.thStartTime)
        self.fStartTime = _fix(self.fStartTime)
        self.saStartTime = _fix(self.saStartTime)
        self.suStartTime = _fix(self.suStartTime)
        self.mEndTime = _fix(self.mEndTime)
        self.tEndTime = _fix(self.tEndTime)
        self.wEndTime = _fix(self.wEndTime)
        self.thEndTime = _fix(self.thEndTime)
        self.fEndTime = _fix(self.fEndTime)
        self.saEndTime = _fix(self.saEndTime)
        self.suEndTime = _fix(self.suEndTime)
